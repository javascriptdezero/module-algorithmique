...
function debutMessageEchec(valeurRecue) {
  if (valeurRecue === undefined) {
    ...
    // On gère les erreurs d'exécution du code
    if (typeof valeurRecue === "object") {
      return `<p>▶︎ Votre fonction provoque une erreur 😅 :</p><p><code>${valeurRecue.message}</code></p><p>Êtes-vous sûr d'avoir pensé au <strong>cas de base</strong> ?`
    }
